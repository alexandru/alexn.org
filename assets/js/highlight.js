...
import clojure from "{% link /assets/js-managed/@highlightjs/cdn-assets/es/languages/clojure.min.js %}?{{ 'now' | date: '%Y%m%d%H%M' }}";
...
import rust from "{% link /assets/js-managed/@highlightjs/cdn-assets/es/languages/rust.min.js %}?{{ 'now' | date: '%Y%m%d%H%M' }}";
