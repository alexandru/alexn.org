...
Run sample deployment (note label section) with the following `docker-compose.yaml`:
...
services:
  app:
    ...
    ports:
      ...
      - "22:22"
    volumes:
      - '/volume2/docker/gitlab/config:/etc/gitlab'
      - '/volume2/docker/gitlab/logs:/var/log/gitlab'
      - '/volume2/docker/gitlab/data:/var/opt/gitlab'
    labels:
