...
last_modified_at: 2024-08-23 18:05:47 +03:00
tags:
  - Products
  - Self Hosting
  - Open Source
...
UPDATE — After writing this article, I proceeded to self-host [Vaultwarden](https://github.com/dani-garcia/vaultwarden) (the FOSS clone of Bitwarden built with Rust). It's incredibly efficient and easy to self-host (if you can manage a server using Docker containers). I'm impressed!
</p>
